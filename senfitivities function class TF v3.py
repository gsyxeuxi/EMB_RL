...
fi_info_10 = tf.convert_to_tensor(np.zeros((4,4)), dtype=tf.float64)
det_T = 0.001
...
for k in range(350): #350 = 0.35s
    ...
    if (k+1) % 50 == 0:
        ...
        # fi_info_10_np = fi_info_10.numpy()
        # # Save each fi_info_10 to a .npz file
        # filename = f"fi_info_10_iter_{k + 1}.npz"
        # np.savez(filename, fi_info_10=fi_info_10_np)
