...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="EMB-fv-v2",
...
def make_env(env_id, idx, run_name):
    def thunk():
        env = EMB_env_fv_v2.EMB_All_info_Env()
...
if __name__ == "__main__":
    ...
    if args.test_model:
        model_path = f"runs/EMB-fv-v2__PPO_fv_v2__1__20240924-101813/PPO_fv_v2.pth"
        epsilon = 1e-8
        eval_episodes = 6
        ...
        while len(episodic_returns) < eval_episodes:
            ...
            if not "final_info" in infos:
                ...
                velocity_buffer.append(env_test.envs[0].unwrapped.x1)  #len(pos) = len(act) - 1
