...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="EMB-fv-v6",
...
def make_env(env_id, idx, run_name):
    def thunk():
        env = EMB_env_fv_v6.EMB_All_info_Env()
...
#     if not os.path.exists('image'):
#         os.makedirs('image')
#     plt.savefig(os.path.join('image', 'position_velocity_single_para_sample.svg'), format="svg")
#     # plt.show()
#     plt.close()
