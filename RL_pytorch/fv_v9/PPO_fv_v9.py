...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="EMB-fv-v9",
...
def make_env(env_id, idx, run_name):
    def thunk():
        env = EMB_env_fv_v9.EMB_All_info_Env()
...
if __name__ == "__main__":
    ...
    if args.test_model:
        model_path = f"runs/EMB-fv-v9__ppo_fv_v9__1__20241008-10-1-train/PPO_fv_v9.pth"
        epsilon = 1e-8
        eval_episodes = 5
