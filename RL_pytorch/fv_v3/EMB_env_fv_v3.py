...
class EMB_All_info_Env(gym.Env):
    ...
    def __init__(self) -> None:
        ...
        """
        high = np.array([100, 400, 5e-5, 1e10], dtype=np.float64)
    ...
    def reset(self, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self.state[2] = random.uniform(self.fv_range_low, self.fv_range_high)
        self.x1 = 0.0
        self.count = 0
    ...
    def step(self, action):
        ...
        x0, k, theta, sv = self._get_obs() #state from last lime
