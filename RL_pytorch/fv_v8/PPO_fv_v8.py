...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="EMB-fv-v8",
...
def make_env(env_id, idx, run_name):
    def thunk():
        env = EMB_env_fv_v8.EMB_All_info_Env()
...
if __name__ == "__main__":
    ...
    if args.test_model:
        # model_path = f"runs/EMB-fv-v8__PPO_fv_v8__1__20241007-153120/PPO_fv_v8.pth"
        epsilon = 1e-8
        eval_episodes = 6
