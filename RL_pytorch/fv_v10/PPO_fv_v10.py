...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="EMB-fv-v10",
...
def make_env(env_id, idx, run_name):
    def thunk():
        env = EMB_env_fv_v10.EMB_All_info_Env()
...
if __name__ == "__main__":
    ...
    if args.test_model:
        # model_path = f"runs/EMB-fv-v10__PPO_fv_v10__1__20241010-141811/PPO_fv_v10.pth"
        epsilon = 1e-8
        eval_episodes = 6
        ...
        while len(episodic_returns) < eval_episodes:
            next_obs_norm_actor =  next_obs_norm[:,2:4]
            with torch.no_grad():
