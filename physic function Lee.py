...
#T_m_max = 3 (Nm)
#F_cl_max = 30000 (N)
#motor_speed _max = 300 (rad/s)

fc = 7.67e-2;           # Coulomb friction [Nm]
fcc = 1000;              # For tanh approximation of signum function
fv = 4.46e-4;            # Viscous friction [Nm/(rad/s)]
# fl = 2.859e-06;          # Load dependent friction [Nm/N]
# fs = 0.0149;             # Static friction [Nm]
J_m = 2.91e-04;          # Moment of inertia [kg*m^2]
km = 21.7e-03;           # Motor torque constant [km], not provided in the paper
eff = 1;                 # Gear efficiency 
gamma = eff * 2.63e-05;  # Total gear ratio [Nm/N]
